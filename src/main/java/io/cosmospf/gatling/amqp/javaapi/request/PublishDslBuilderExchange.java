...
public class PublishDslBuilderExchange {
    ...
    private final io.cosmospf.gatling.amqp.request.PublishDslBuilderExchange wrapped;

    public PublishDslBuilderExchange(io.cosmospf.gatling.amqp.request.PublishDslBuilderExchange wrapped) {
