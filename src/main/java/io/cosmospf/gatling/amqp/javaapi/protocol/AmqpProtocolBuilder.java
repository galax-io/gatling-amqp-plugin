...
public class AmqpProtocolBuilder implements ProtocolBuilder{
    ...
    private io.cosmospf.gatling.amqp.protocol.AmqpProtocolBuilder wrapped;

    public AmqpProtocolBuilder(io.cosmospf.gatling.amqp.protocol.AmqpProtocolBuilder wrapped) {
    ...
    public AmqpProtocolBuilder declare(AmqpQueue q) {
        ...
        this.wrapped = wrapped.declare(io.cosmospf.gatling.amqp.Predef.queue(
                q.getName(),
                q.getDurable(),
                q.getExclusive(),
                q.getAutoDelete(),
    ...
    public AmqpProtocolBuilder declare(AmqpExchange e) {
        this.wrapped = wrapped.declare(io.cosmospf.gatling.amqp.Predef.exchange(
                e.getName(),
                e.getExchangeType(),
                e.getDurable(),
                e.getAutoDelete(),
    ...
    public AmqpProtocolBuilder bindQueue(
        ...
        this.wrapped = wrapped.bindQueue(
                io.cosmospf.gatling.amqp.Predef.queue(
                        q.getName(),
                        q.getDurable(),
                        q.getExclusive(),
                        q.getAutoDelete(),
                ...
                io.cosmospf.gatling.amqp.Predef.exchange(
                        e.getName(),
                        e.getExchangeType(),
                        e.getDurable(),
                        e.getAutoDelete(),
