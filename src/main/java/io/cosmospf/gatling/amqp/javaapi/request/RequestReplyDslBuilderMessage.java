...
public class RequestReplyDslBuilderMessage {
    private io.cosmospf.gatling.amqp.request.RequestReplyDslBuilderMessage wrapped;

    public RequestReplyDslBuilderMessage(io.cosmospf.gatling.amqp.request.RequestReplyDslBuilderMessage wrapped){
