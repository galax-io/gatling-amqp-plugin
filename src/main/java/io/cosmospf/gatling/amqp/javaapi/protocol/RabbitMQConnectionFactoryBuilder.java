...
public class RabbitMQConnectionFactoryBuilder{
    private io.cosmospf.gatling.amqp.protocol.RabbitMQConnectionFactoryBuilder wrapped;

    public RabbitMQConnectionFactoryBuilder(io.cosmospf.gatling.amqp.protocol.RabbitMQConnectionFactoryBuilder wrapped){
