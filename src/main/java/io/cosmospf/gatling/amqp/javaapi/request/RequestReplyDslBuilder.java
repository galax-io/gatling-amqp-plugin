...
public class RequestReplyDslBuilder implements ActionBuilder {
    private io.cosmospf.gatling.amqp.request.RequestReplyDslBuilder wrapped;

    public RequestReplyDslBuilder(io.cosmospf.gatling.amqp.request.RequestReplyDslBuilder wrapped) {
