...
public class PublishDslBuilderExchange {
    ...
    private final org.galaxio.gatling.amqp.request.PublishDslBuilderExchange wrapped;

    public PublishDslBuilderExchange(org.galaxio.gatling.amqp.request.PublishDslBuilderExchange wrapped) {
